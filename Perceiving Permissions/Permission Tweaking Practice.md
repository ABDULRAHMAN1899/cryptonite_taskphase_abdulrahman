...
* the world does have execute permissions
hacker@permissions~permission-tweaking-practice:~$ chmod u+rwx,o+w /challenge/pwn
You set the correct permissions!
Round 5 (of 8)!
...
- the world doesn't have write permissions
* the world does have execute permissions
hacker@permissions~permission-tweaking-practice:~$ chmod g+rx,o+rx /challenge/pwn
You set the correct permissions!
...
pwn.college{8qlCMM6aP1VyWuPlT_0rhknY-ET.dBTM2QDL5kDN0czW}
```
## Learning:
